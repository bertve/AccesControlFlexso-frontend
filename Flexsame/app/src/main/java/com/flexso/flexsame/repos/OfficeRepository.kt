...
class OfficeRepository(private val companyService: CompanyService) {
    ...
    suspend fun getAuthorizedPersons(officeId: Long) {
        ...
        try {
            ...
            Log.i("api", e.message
                    ?: "no message but something went wrong with AuthorizedPersons request")
        }
    }
    ...
    suspend fun getUnAuthorizedPersons(officeId: Long) {
        ...
        try {
            ...
            Log.i("unAuth", e.message
                    ?: "no message but something went wrong with deAuthorizedPersons request")
        }
    }
